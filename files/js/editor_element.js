    ...
    var CodeBlock = PlatformElement.extend({
        ...
        setUpEditor: function() {
            ...
            this.editor.session.setOptions({
                ...
                'userWorker': false // workers rebind window.require so we need to disable them
            });
            ...
            /**
             * Function that keeps the settings popup
             * from displaying on certain element clicks
             */
            this.editor.on('focus', function(e) {
                e.stopPropagation();
                _W.pauseClickHandler = true;
            });
